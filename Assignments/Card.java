...
/*
Consider the class Card that represents a standard playing card
(complete class given below). Create a class called DeckOfCards that stores 52 objects
of the Card class. In addition, include a constructor and methods to shuffle the deck,
deal a card and report the number of cards left in the deck.  The shuffle method should 
assume a full deck.
*/
